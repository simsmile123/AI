...
def num_41(subject):
   ...
   pattern = "^[xXoO]*[.][xXoO]*$" #(([xXOo].)[xXOo]))\1{8}" 
   match = re.match(pattern, subject, re.I)
   print (match.group(0)) if match != None else print (match)
...
while(True):
   #print(len('xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.xo'))
